...
function Signup({ title }: any) {
  ...
  useEffect(()=>{
    if(user.email.length > 0 && user.password.length > 0 && user.username.length > 0 && user.firstname.length>0){
          ...
          <div>
            ...
            <form className="my-8" onSubmit={onSignup}>
              ...
              <div className="w-full flex justify-center gap-3 text-sm text-gray-300 relative top-3">
                Have an account?
                <Link href={"./login"} className="text-gray-100 hover:text-cyan-300">Sign in</Link>
              </div>
